...
class CourseWaffleFlagsSerializer(serializers.Serializer):
    ...
    def get_enable_course_optimizer_extended_report(self, obj):
        """
        Method to get the enable_course_optimizer_extended_report waffle flag
        """
        course_key = self.get_course_key()
        return toggles.enable_course_optimizer_extended_report(course_key)
