...
from common.djangoapps.course_modes.toggles import (
    course_modes_mfe_track_selection_is_active,
)
...
class TestCourseModesMfeTrackSelectionToggle(TestCase):
    ...
    @patch(
        "common.djangoapps.course_modes.toggles.COURSE_MODES_MFE_TRACK_SELECTION.is_enabled"
    )
