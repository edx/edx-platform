...
extract_translations: ## extract localizable strings from sources
	...
	cd conf/locale/en/LC_MESSAGES && \
		FILES_TO_MERGE="django.po wiki.po mako.po"; \
		[ -f edx_proctoring_proctortrack.po ] && FILES_TO_MERGE="$$FILES_TO_MERGE edx_proctoring_proctortrack.po"; \
		msgcat $$FILES_TO_MERGE -o django.po
